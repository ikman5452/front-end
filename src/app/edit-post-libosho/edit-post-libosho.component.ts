...
const date = new Date();
@Component({
  selector: 'app-edit-post-libosho',
  templateUrl: './edit-post-libosho.component.html',
  styleUrls: ['./edit-post-libosho.component.scss']
})
export class EditPostLiboshoComponent implements OnInit{
  ...
  updatePost(id: any): void {
    ...
    this.authService.updatePostLibosho({
      category: "Libosho",
      title: this.title,
      photoMalumot: this.photoMalumot,
      textMalumot: this.textMalumot,
