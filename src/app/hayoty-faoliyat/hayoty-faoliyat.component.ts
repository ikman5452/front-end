...
@Component({
  selector: 'app-hayoty-faoliyat',
  templateUrl: './hayoty-faoliyat.component.html',
  styleUrls: ['./hayoty-faoliyat.component.scss']
})
export class HayotyFaoliyatComponent implements OnInit{
