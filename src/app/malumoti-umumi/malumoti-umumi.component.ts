...
@Component({
  selector: 'app-malumoti-umumi',
  templateUrl: './malumoti-umumi.component.html',
  styleUrls: ['./malumoti-umumi.component.scss']
})
export class MalumotiUmumiComponent implements OnInit {
